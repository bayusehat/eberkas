<section>
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ url('indihome/old') }}" class="btn btn-danger float-right"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
        <div class="card-body">
            @if(session('success'))
                                ...
                                <tbody>
                                    @foreach ($data as $f => $fl)
                                        <tr>
                                            ...
                                            <td>{{ $fl->file_type }}</td>
                                            <td>
                                                <a href="{{ url("indihome/old/download/$fl->id") }}" class="btn btn-success"> Download</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
