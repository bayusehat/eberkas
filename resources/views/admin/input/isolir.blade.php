...
<section>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ url('isolir/insert') }}" method="POST" id="formBna" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xl-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="lama_isolir_transaksi" id="lama_isolir_transaksi" class="form-control form-control-sm">
                                ...
                                <option>SATU BULAN</option>
                                <option>DUA BULAN</option>
                                <option>TIGA BULAN</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-xl-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm datepicker" name="isolir_dari" id="isolir_dari" value="{{ old('isolir_dari') }}">
                                    @error('isolir_dari') <small class="text-danger">{{ $message }}</small> @enderror
                                </div>
                                <div class="col-md-6 col-sm-12 col-xl-6">
                                    <label for="isolir_sampai">Sampai Tanggal</label>
                                    <input type="text" class="form-control form-control-sm datepicker" name="isolir_sampai" id="isolir_sampai" value="{{ old('isolir_sampai') }}">
