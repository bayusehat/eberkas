...
<script>
    ...
    function loadData(){
        $('#tableData').DataTable({
            ...
            columns: [
                { name: 'id_role', searchable: false, orderable: true, className: 'text-center' },
                { name: 'nama_role' },
    ...
    function show(id){
        ...
        $.ajax({
            ...
            dataType : 'JSON',
            success:function(res){
                $('#nama_role').val(res.nama_role)
                $('#update').attr('onclick','ubah('+res.id_role+')');
            }
        })
    }
