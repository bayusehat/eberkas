...
<section>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ url('bna/update/'.$transaksi->id_transaksi) }}" method="POST" id="formBna" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xl-6">
                        <div class="form-group">
                            ...
                            <select name="segment_transaksi" id="segment_transaksi" class="form-control form-control-sm">
                                ...
                                <option value="RESIDENSIAL" @if($transaksi->segment_transaksi == 'RESIDENSIAL') {{ 'selected' }} @else {{ '' }} @endif>RESIDENSIAL</option>
                                <option value="BISNIS" @if($transaksi->segment_transaksi == 'BISNIS') {{ 'selected' }} @else {{ '' }} @endif>BISNIS</option>
                            </select>
