...
<section>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ url('isolir/update/'.$transaksi->id_transaksi) }}" method="POST" id="formBna" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xl-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_identitas_transaksi" id="jenis_identitas_transaksi" class="form-control form-control-sm">
                                ...
                                @endif>KTP</option>
                                <option value="SIM" 
                                @if ($transaksi->jenis_identitas_transaksi == 'SIM')
                                    {{'selected'}}
                                @else
                                    {{''}}
                                @endif>SIM</option>
                    ...
                    <div class="col-md-6 col-sm-12 col-xl-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_isolir_transaksi" id="jenis_isolir_transaksi" class="form-control form-control-sm">
                                ...
                                <option @if($transaksi->jenis_isolir_transaksi == 'SLJJ') {{'selected'}} @else {{''}} @endif>SLJJ</option>
                                <option @if($transaksi->jenis_isolir_transaksi == 'TOTAL') {{'selected'}} @else {{''}} @endif>TOTAL</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="lama_isolir_transaksi" id="lama_isolir_transaksi" class="form-control form-control-sm">
                                ...
                                <option @if($transaksi->lama_isolir_transaksi == 'DUA BULAN') {{'selected'}} @else {{''}} @endif>DUA BULAN</option>
                                <option @if($transaksi->lama_isolir_transaksi == 'TIGA BULAN') {{'selected'}} @else {{''}} @endif>TIGA BULAN</option>
                            </select>
