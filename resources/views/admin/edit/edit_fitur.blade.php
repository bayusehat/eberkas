...
<section>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ url('fitur/'.request()->segment(2).'/update/'.$transaksi->id_transaksi) }}" method="POST" id="formBna">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xl-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_layanan" id="id_layanan" class="form-control form-control-sm">
                                ...
                                <option value="PEMASANGAN" @if($transaksi->layanan_fitur_transaksi == 'PEMASANGAN') {{'seleceted'}} @else {{''}} @endif>PEMASANGAN</option>
                                <option value="PENCABUTAN" @if($transaksi->layanan_fitur_transaksi == 'PENCABUTAN') {{'seleceted'}} @else {{''}} @endif>PENCABUTAN</option>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-12 col-xl-6">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="id_fitur">Jenis Fitur :</label><br>
                                @foreach ($fitur as $i => $f)
                                    @php
                                        $fi = FiturIndihome::where(['id_transaksi'=>$transaksi->id_transaksi, 'id_fitur' => $f->id_fitur])->first();
                                    @endphp
                                    <input type="checkbox" name="id_fitur[]" onclick="getHunting({{ $f->id_fitur }})" value="{{ $f->id_fitur }}" @if($fi) {{'checked'}} @else {{''}} @endif> {{ $f->nama_fitur }}<br>
                                @endforeach
                            </div>
                            <div id="hunting">
                                <div class="form-group">
                                    <label for="induk_hunting_fitur_transaksi">Induk Hunting :</label>
                                    <input type="text" class="form-control form-control-sm" name="induk_hunting_fitur_transaksi" id="induk_hunting_fitur_transaksi" value="{{ $transaksi->induk_hunting_fitur_transaksi }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="anak_hunting_fitur_transaksi" id="anak_hunting_fitur_transaksi" value="{{ $transaksi->anak_hunting_fitur_transaksi }}">
