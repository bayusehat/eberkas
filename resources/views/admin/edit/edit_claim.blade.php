...
<section>
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ url('claim/update/'.$transaksi->id_transaksi) }}" method="POST" id="formBna">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xl-6">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="jenis_claim_transaksi">Jenis Claim :</label>
                                <br>
                            ...
                            <div class="form-group">
                                <label for="jumlah_claim_transaksi">Jumlah Claim :</label>
                            ...
                            <div class="form-group">
                                <label for="alasan_claim_transaksi">Alasan Claim :</label>
                            ...
                            <div class="form-group">
                                <label for="identifikasi_claim_transaksi">Identifikasi Awal atas Claim :</label>
